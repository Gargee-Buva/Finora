...
import { useGetAllTransactionsQuery , useBulkDeleteTransactionMutation } from "@/features/transaction/transactionAPI";
...
const handleFilterChange = (filters: Record<string, string>) => {
  ...
  setFilter((prev) => ({
    ...prev,
    type: type ? (type.toUpperCase() as _TransactionType) : undefined,
    recurringStatus: frequently
      ? (frequently.toUpperCase() as "RECURRING" | "NON_RECURRING")
      : undefined,  
    /*type: type ? (type.toUpperCase() as _TransactionType) : undefined,
    recurringStatus: frequently || frequently === "" ? undefined : (frequently.toUpperCase() as "RECURRING" | "NON_RECURRING"),*/
    pageNumber: 1,
  }));
};
